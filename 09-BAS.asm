...
021A                      HERE   a
021A    EC   El           LDD    ,6**       POP AND SET FLAGS
021C                      RATS   NO         LOGICAL OP
                »
02 ID   8D   08   XP18    BSR    EXPR2
02 IF   AC   62           CMPX   2,8        COMPARE WITH LEFT
0221    34   01           PSHS   CC
0223    4F                CLRA
...
Dr. Dobb ’s Journal, Issue 55, May 1981
...
Dr. Dobb ’s Journal, Issue 55, May 1981
                                          ...
                                          ANT BITS
                                           ...
                                           O2AB 82     00              SBCA   #0
                                                                                           ...
                                                                                           (continued on the top of page 26)
...
s'- 8.8 Tiny Basic for 6809’s (Continued)
...
Dr. Dodd's Journal, Issue 55, May 1981
...
N3 UJ
O O
                                            S. B. Tiny Basic for 6809’s (Continued)
                                            O52E 86     08             LDA     ••1FVH    CONTROL H                           0613 32     62               LEAS   2,6
                                            0530 90     7F             J SR    <OUTC     AND BACK UP OVER SPACE              0615 IF     05               TFR    D, PC
                                            0532 20     D4             BRA     GL1                                                                4
                                            0534 9D     7D     GL4     J SR    <CRLF                                         0617 17     FC87     PUSHA     LBSR  SIZE       ANU ROOM?
                                            0536 32     64             LEAS    4,5       POP OFF TEMPORARIES                 061A 83     OOOC               SUBD  • 12
                                            0530 86     3F             LDA     O'?       QUESTION MARK PROMPT                06ID 1023   FB46              LBLS   QSORRY
                                            O53A 20     C2             BRA     GETLN                                         0621 35     06                 PULS  D          RETURN ADDR
                                            0530 32     64     GLO     LEAS    4,8                                           0623 AE     48                LDX    LOPVAR,U TEST THIS
                                            O53E A7     22             STA     2, Y      THROW ANOTHER RETURN                0625 27     13                 BEQ   PU1
                                            0540                       RATS                                                  0627 AE     C8 10             LDX    LOPPT,U
                                                               ***«*»****«************ *******                               062A 34     10                 PSHS   X
                                                               4 PRTNUf AND FRIENDS                                          062C AE     4E                LDX    LOPLN.U
                                                               4                                                             062E 34     10                PSHS   X
                                            0541   8E   OOOA   PRTNUM LDX     • 10                                           0630 AE     4C                 LDX    LOPLMT,U
                                            0544   34   36             PSHS   D, Y, X    SAVE PRG POINTER AND STOPPER        0632 34      10                PSHS   X
                                            0546   E6   41             LDB    FLDCNT,U                                       0634 AE     4A                 LDX    LOPINC,U
                                            0548   5A                  DECB                                                  0636 34     10                 PSHS   X
                                            0549   49                  ROLA              PUT SIGN OF QUANTITY INTO LOW B     0638 AE     48                 LDX    LOPVAR,U
                                            054A   59                  ROLB                                                  063A 34     10       PU1       PSHS   X
                                            054B   ID                  SEX                                                   063C IF     05                 TFR   D,PC       AND RETURN
                                            0540   IF   02             TFR    D, Y       PUT INTO COUNTER                                          ******************************
                                                               4444444                                                                            4 STI (ALIAS START)
                                            054E   EC   El             LDD    0,8**      SET FLAGS                                                 4    INITIALIZE AND ENTER COMMAND
                                            0550   2A   07             BPL    PN2        COMPLEMENT IF NEGATIVE                                   4     MODE
                                            0552   43                  COMA                                                                       4
                                            0553   53                  COMB                                                   063E 4F 4B OD       OK       FCC     'OK',13
                                            0554   C3   0001           ADDD   •1                                              0641 30   8D FABB   STI      LEAX   TSTNUM,PCR
                                            0557   31   3E     PN1     LEAY   -2, Y      DECREMENT PLACE COUNT                0645 IF   10                 TFR    X, D
                                            0559   34   06     PN2     PSHS   D          SAVE QUOTIENT                      ! 0647 IF   8B                 TFR    A, DP
                                            055B   CC   OOOA           LDD     • 10      DIVIDE BY 10 TO GET                  0649 33   8D 0512            LEAU   DATAS,PCR
                                            O55E   17   01CC           LBSR    DIV       NEXT DIGIT                           064D 32   C8 CA              LEAS   VARBGN,U
                                            0561   26   F4             BNE     PN1       HAVE NOT GOT ALL                     0650 9D   7D                 J SR   CCRLF
                                            0563   IF   20             TFR     Y,D       PUT PLACE COUNT INTO B               0652 31   8C E9              LEAY   OK,PCR    PRINT OK AND PROMPT
                                            0565   20   02             BRA     PN3                                            0655 17   FF34               LBSR   PRTSTL
                                            0567   9D   79     PN4     □ SR    <SPACE    PRINT SPACE                          0658 4F                      CLRA             B IS ALREADY ZERO
                                            0569   CO          PN3     SUBB    •2        DEC SPACE COUNT                      0659 ED   48                 STD    LOPVAR,U NO CURRENT FOR LOOPS
                                                        02
                                            056B   2A   FA             BPL     PN4                                            065B ED   46                 STD    STKGOS,U NOR GOSUB RETURNS
                                            056D   56                  RORB              PUT SIGN BIT INTO CARRY              065D 86   3E        ST3      LDA    •'>       PROMPT TO ENTER A STATEMENT
                                            056E   24   04             BCC     PN6       DONT PRINT MINUS                     065F 17   FE9C               LBSR   GETLN
                                            0570   86                  LDA     • '-      LEADING MINUS                        0662 34   20                 PSHS   Y         SAVE POINTER TO END OF TEXT
                                                        2D
                                            0572   9D   7F     PN8     J SR    <OUTC                                          0664 31   C8 18              LEAY   BUFFER,U POINT TO START
                                            0574   35                  PULS    D                                              0667 9D   00                 J SR   <TSTNUM   WILL RETURN ZERO IF NO NUM
                                                        06     PN6                       GET REMAINDER
                                            0576   Cl                  CMPB    • 10      DONE?                                0669 34   07                 PSHS   CC, D
                                                        OA
                                            0578   27                  BED     PN7                                            066B 9D   72                 J SR   <IGNBLK
                                                        06
                                            057A   IF                  TFR     B, A                                           066D EC   61                 LDD    1,6       REGAIN LINE NUM
                                                        98
  Dr. Dobb ’s Journal, Issue 55, May 1981
                                            ...
                                            0570   8A   30             ORA     ••30
                                                   20                          PNG                                            0671 10AF 42                 STY    CURRNT,U MAKE THE CURRENT LINE
                                            057E        F2             BRA
...
06E9 53                      COMB
                                                        ...
                                                        (Continued on next page)
s s S. B. Tiny Basic for 6809’s (Continued)
                                           OAEA A3   A5                COM      5,S
                                           OAEC AO   AA                NEG      A,S
