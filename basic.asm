...
*	BY JAMES A. HINDS
*
* Transcribed and updated for the A09 assembler
* by Lee Morgan
*******************************

	NAM 'Santa Barbara Tiny Basic'
*** External dependencies ***
* Check if data is waiting, status is return in Zero Flag (CC.Z)
IOST	EQU	$D3F7

* Read data from I/O device into the A Accumulator
IORD	EQU	$D3E5

* Write data in A Accumulator to I/O device
IOWR	EQU	$D3F9
